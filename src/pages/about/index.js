  ...
  <Layout>
    <div className="about--background">
      <div className="about--description">
        <h2 className="about--description__title">Welcome to <span>Camp Cosmos</span></h2>
      ...
      <img className="w-full transform h-screen object-cover overlay-item z-10 hidden lg:block" src='/images/camp-cosmos-about-page.svg' alt='cosmos' />
    </div>
  </Layout>
);
