...
const Galaxy = () => (
  <Layout>
    <div className="w-full transform hidden lg:block h-screen object-cover overlay-item z-10 galaxy--background">
      ...
      <img src='/images/camp-cosmos-galaxy-page.svg' alt='cosmos' />
    </div>
  </Layout>
);
